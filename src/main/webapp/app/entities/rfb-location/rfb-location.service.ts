...
export class RfbLocationService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/rfb-locations';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IRfbLocation[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
